...
<% 
	...
	Cart cart = sessionContainer.getCart();
	
	Order order = new Order();
	order.setCustomer(sessionContainer.getCustomer());
	order.setTotal_price(cart.calculateTotalPrice());
	order.setStatus("Y");
	order.setOrderDetailList(cart.getOrderDetails());
									...
									<table width="80%" border="0" cellspacing="0"
										...
										<tr>
											...
											<td style="padding-top: 30px">
												<font style="font-weight: bold; color: #FF0000">您的购买已经成功！请耐心等待您的货品，谢谢惠顾！</font>
												<br />
												<br />
